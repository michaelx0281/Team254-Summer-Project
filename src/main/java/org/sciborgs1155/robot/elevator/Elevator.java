...
public class Elevator extends SubsystemBase implements Logged {
  ...
  private enum GEARING { // TODO Work on changing between high gear and low gear later!
    _HIGH(12.06),
    _LOW(42.44);

    private double gearing;

    private GEARING(double gearing) {
      this.gearing = gearing;
    }
  } // TODO create different IntakeConstants!
  ...
  @Log.NT
  private ProfiledPIDController pid = new ProfiledPIDController(kP, kI, kD, constraints, 0.02);
  ...
  public Elevator(ElevatorIO hardware) {
    ...
    SmartDashboard.putData(
        "elevator quasistatic backward", elevatorSysidQuasistatic(Direction.kForward));
  }
